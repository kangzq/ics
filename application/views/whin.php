...
<div class="container" style="width:90%">
	...
	<div class="hide"><table id="tr_template">
		<tr><td><input type="checkbox" name="item[_IDX_][packed]" value="1" checked /></td>
			...
			<td><input type="number" name="item[_IDX_][box_num]" value="" placeholder="Boxes #" class="input-mini" min=1 /></td>
			<td><input type="number" name="item[_IDX_][box_capacity]" value="" class="input-mini" placeholder="QTY(@CTN)" min=1 /></td>
			<td><div class="input-append"><input type="number" name="item[_IDX_][quantity]" value="" placeholder="QTY" class="span2 input-mini" required min=1 /><span class="add-on">PCS</span></div></td></tr>
		</table>
	</div>
</div>
